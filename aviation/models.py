...
class airlines(Base):
    ...
    airlines_id = db.Column(db.Integer, primary_key=True)
    airline = db.Column(db.String(length=50))
    iata = db.Column(db.String(length=5))
    icao = db.Column(db.String(length=5))
...
class flights(Base):
    ...
    flight_number = db.Column(db.String(length=5))
    flight_type = db.Column(db.String(length=15))
